...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if (target == kTargetIpad)
    {
        ...
        CCEGLView::sharedOpenGLView()->setDesignResolutionSize(320 * 4, 640, kResolutionNoBorder);
    }
    ...
    else 
    {
		...
		// [Jijian.Zhou, 2013.5.2]
		CCApplication::sharedApplication()->setResourceRootPath("../Resources");
    }

	tolua_userobj_open(CCLuaEngine::defaultEngine()->getLuaState());
